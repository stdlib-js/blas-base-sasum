...
var y=require('@stdlib/math-base-special-absf/dist'),j=require('@stdlib/number-float64-base-to-float32/dist');function b(e,a,u){var i,r;if(i=0,e<=0||u<=0)return i;for(e*=u,r=0;r<e;r+=u)i=j(i+y(a[r]));return i}n.exports=b
});var m=v(function(z,f){
var d=require('@stdlib/math-base-special-absf/dist'),F=require('@stdlib/number-float64-base-to-float32/dist');function R(e,a,u,i){var r,s,t;if(r=0,e<=0)return r;for(s=i,t=0;t<e;t++)r=F(r+d(a[s])),s+=u;return r}f.exports=R
